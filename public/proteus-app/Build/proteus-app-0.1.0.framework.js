...
function _UnityEvent(eventName, jsonData) {
 try {
  window.dispatchReactUnityEvent("UnityEvent", UTF8ToString(eventName), UTF8ToString(jsonData));
 } catch (e) {
  console.error(`Failed to dispatch event from Proteus WebGL: ${e}`);
 }
}
